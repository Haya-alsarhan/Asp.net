        ...
        <legend class="legend"> <strong>Message Detailes</strong></legend>
            ...
            <asp:DetailsView ID="DetailsView1" runat="server" Height="120px" Width="90%" AutoGenerateRows="False"
                ...
                <Fields>
                    ...
                    <asp:BoundField DataField="msg" HeaderText="Message" SortExpression="msg"   Visible="False" />
...
and m.id=@id">
         ...
         <legend class="legend"> <strong>Message Replay</strong></legend>
                ...
                <asp:TextBox ID="txtTitle" runat="server"  Width="40%" Height="35px" 
                   CssClass="style12">Re:</asp:TextBox>
           <p>
...
<p class="style9">
    <asp:Button ID="Button1" runat="server" Text="Send Message" CssClass="style10" BackColor="#646464" 
