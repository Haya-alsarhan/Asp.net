...
public partial class UserControl_GetPassword : System.Web.UI.UserControl
{
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                smtp.Port = 587;
                smtp.Credentials = new System.Net.NetworkCredential("haya909090@gmail.com", "1234_haya");
                smtp.EnableSsl = true;
                smtp.Send(Msg);
                //Msg = null;
