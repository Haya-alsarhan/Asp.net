    ...
    <div class="accountInfo">
        <fieldset class="style6">
            ...
            <asp:GridView ID="grMeeting" runat="server" AutoGenerateColumns="False" 
                ...
                GridLines="None"  AllowPaging="True"    Width="97%"   CssClass="mGrid" 
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:ConnectionStringp %>" SelectCommand="select distinct email,first_name+' '+last_name as full_name ,sname
