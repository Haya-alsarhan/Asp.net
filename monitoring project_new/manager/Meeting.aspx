...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:HyperLink ID="HyperLink1" runat="server" 
        NavigateUrl="~/manager/MyMeeting.aspx" >My Meetings</asp:HyperLink>
        ...
        <fieldset class="style9">
            ...
            <table class="style12">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDate" runat="server" CssClass="textbox" MaxLength="10"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                            ControlToValidate="DropDownList1" ErrorMessage="*" ForeColor="#006699" 
                            ToolTip="Time is Required" ValidationGroup="b"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="style13">
            ...
            <asp:GridView ID="grMeeting" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    <asp:BoundField DataField="meeting_id" HeaderText="ID" InsertVisible="False" 
                        ReadOnly="True" SortExpression="meeting_id" Visible="false">
